...
## [Node Weekly 2호: 생성자, 비동기 패턴, 홈 오토메이션와 그 이상의 것들](http://nodeweekly.com/archive/2.html)
Node Weekly를 지난주 뉴스레터에서 출시했습니다. [Node Weekly](http://nodeweekly.com/) 가 다루고 있는 분야를 확인 해보세요


- - -
# 스폰서기사

## [Frontend Masters: 이안 존슨(Ian Johnson)이 직접 진행하는 D3.js를 사용한 데이터 시각화 실시간 온라인 워크샵](https://frontendmasters.com/workshops/interactive-data-visualization-d3js/)
...
Egghead.io 개발자 John이 3분의 짧은 영상에 담았습니다.
...
WHATWG HTML5 스펙을 기반으로 하며, [Node Weekly](http://nodeweekly.com/archive/2.html)에도 소개되었습니다.
...
## [소프트웨어 개발자 (자바스크립트 또는 자바) - 연구/개발직 @ 오스트리아 비엔나](http://www.weblyzard.com/jobs/)
...
## [OrderGroove에서 근무할 자바스크립트 제다이 (프론트엔드 기술 리더) @ 뉴욕주, 뉴욕시](https://hire.jobvite.com/j?cj=oKJGXfwQ&amp;s=Cooper_Press)
