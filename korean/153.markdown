...
## [Phusion Passenger의 Node.js 지원이 오픈소스화되다.](http://blog.phusion.nl/2013/10/23/phusion-passengers-node-js-support-has-been-open-sourced/)
Passenger는 Ruby 세계의 초기부터 많은 인기를 얻고있는 유명한 애플리케이션 서버 입니다. 지금 Passenger는 Nginx 또는 Apache 뒤의 노드 응용프로그램들을 배포하는데 더욱 쉽게 무료와 오픈소스로 제공합니다.
